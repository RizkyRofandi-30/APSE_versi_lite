    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 shadow-lg text-white flex flex-col" style="background-color:#008A42;">
            ...
            <nav class="mt-6 space-y-1 flex-1">
                ...
                <!-- Page aktif -->
                <a href="medlicense.html" class="flex items-center px-4 py-3 bg-white text-green-700 font-semibold">
                    <i class="fas fa-chart-bar mr-3"></i> Medical License
                </a>

                <a href="healthygate.html" class="flex items-center px-4 py-3 hover:bg-white/20 transition text-white">
        ...
        <div class="flex-1 flex flex-col bg-white overflow-y-auto">
            ...
            <div id="myModal" class="fixed inset-0 bg-black/60 hidden z-50 flex items-center justify-center p-4">
                <div class="w-full max-w-xs rounded-xl shadow-2xl text-center p-5" style="background-color:#F5F5F5;">
                    ...
                    <div class="mb-4">
                        <h2 class="font-bold text-lg text-black mt-0 leading-tight">Surat Rekomendasi</h2>
                    </div>
...
<script>
    ...
    // Untuk Berkas di tabel Permohonan
    function openFormPermohonanan() {
        document.getElementById("myForm").classList.remove("hidden");
    }

    // Untuk Berkas di tabel Perizinan
    function openFormPerizinan() {
        document.getElementById("formBidan").classList.remove("hidden");
    }

    function closeFormPerizinan() {
        document.getElementById("formBidan").classList.add("hidden");
    }

    function openFormPerizinan() {
        document.getElementById("formDokter").classList.remove("hidden");
    }

    function closeFormPerizinan() {
        document.getElementById("formDokter").classList.add("hidden");
    }
